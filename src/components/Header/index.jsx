...
import CallBackModal from "../Home/CallBackModal";
import "./Header.scss";
...
const Header = () => {
  ...
  return (
    <>
        ...
        <div className="container">
          <div className="header-content">
            <div className="header-content__left">
              ...
              <div className="header-left__delivery">
                <p className="left-delivery__title">
                  Доставка цветов в <span> г.Севастополь</span>
                </p>
                <p className="left-delivery__title">
                  или самовывоз из магазина.
                </p>
                <div className="left-delivery__rate">
                  <div className={`rate-show`}>
                    <p className="rate-show__title">30 минут</p>
                    <p className="rate-show__desc">Среднее время доставки</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="header-content__right">
              ...
              <div className="header-right__info">
                <div className="right-info">
                  <a href="tel:89780000000" className="right-info__phone">
                    8 978 000-00-00
                  </a>
                  <p>Прием заказов с 7:00 до 23:00</p>
                  <div className="right-info__hidden">
                    <div className="hidden-phone">
                      <p className="hidden-title">Наши номера:</p>
                      <a href="">8 978 000-00-00</a>
                      <a href="">8 978 000-22-11</a>
                    </div>
                    <div className="hidden-social">
                      <p className="hidden-title">Написать нам:</p>

                      <a href="" className="hidden-social__item">
                        <svg
                          width="800px"
                          height="800px"
                          viewBox="0 0 32 32"
                      ...
                      <div className="hidden-social__item hidden-callback">
                        <div className="hidden-callback__img">
                          <svg
                            width="800px"
                            height="800px"
                            viewBox="0 0 24 24"
                        ...
                        <a href="#openModal" className="hidden-callback__text">
      ...
      {<HeaderMenu openCart={openCart} setOpenCart={setOpenCart} />}
      {<CallBackModal />}
    </>
  );
};
