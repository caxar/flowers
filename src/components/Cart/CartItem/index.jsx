    ...
    <div className="cart-item">
      <div className="cart-item__list">
        <div className="cart-item__block">
          <div className="cart-list_image">
            <a href="">
              <img src={imageUrl} alt="" />
            </a>
          </div>
          <div className="cart-list_name">
            <a href="">{title}</a>
            <div
              className="cart-list_del"
        ...
        <div className="cart-list_price">
          <div className="cart-list_block">
            <div className="new">
              {/* {price?.newPrice.toLocaleString("ru-RU")} &#8381; */}
              {price.newPrice} &#8381;
            </div>
            {price.oldPrice && (
              <div className="old">
          ...
          <div className="cart-list_count">
            <div
              className={`count-minus ${count === 1 ? "disabled" : ""}`}
              onClick={() => onClickCounterMinus()}
            >
              <svg
                width="10"
                height="2"
              ...
              >
                <path
                  d="M0.332682 1.66536H9.66602V0.332031H0.332682V1.66536Z"
                  fill="#0B1126"
                ></path>
              </svg>
            </div>
            <input type="text" value={`${count === 0 ? "1" : count}`} />
            <div className="count-plus" onClick={() => onClickCounterPlus()}>
              <svg
                width="10"
                height="10"
                viewBox="0 0 10 10"
              ...
              >
                <path
                  d="M0.332682 5.66536H4.33268V9.66537H5.66602V5.66536H9.66602V4.33203H5.66602V0.332031H4.33268V4.33203H0.332682V5.66536Z"
                  fill="#0B1126"
                ></path>
              </svg>
            </div>
